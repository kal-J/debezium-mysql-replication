...
cat > mysql-sink-connector-config.json << EOF
{
  ...
  "config": {
    ...
    "connection.url": "jdbc:mysql://DEST_MYSQL_HOST:DEST_MYSQL_PORT/DEST_MYSQL_DATABASE?autoReconnect=true&useSSL=false&connectTimeout=10000&socketTimeout=30000&tcpKeepAlive=true",
    "connection.username": "DEST_MYSQL_USER",
    "connection.password": "DEST_MYSQL_PASSWORD",

    "connection.pool.size": "5",
    "connection.pool.max.idle.time.seconds": "300",
